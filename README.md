...
![北京房屋交易价值地图](public/assets/beijing-map-hero.webp)

## 已经可以做什么

| 模块 | 解决的问题 | 当前能力 |
| --- | --- | --- |
| 北京小区交易价值地图 | 哪些小区值得优先核验？ | 北京七区下钻、7,972 个小区点位、四类筛选、小区成交与同质可比证据、周边地图和相邻小区参照 |
| 买房现金流测算器 | 买房和持有现金的长期结果差多少？ | 自住/出租两种口径、组合贷款、逐月现金流、总资产曲线、临界涨幅、双变量压力测试和收入下降压力 |
| 房源证据评分卡 | 三套具体房源怎么比较？ | 三个候选并排比较，按地段、配套、交通、环境、户型、价格机会和流动性评分 |
